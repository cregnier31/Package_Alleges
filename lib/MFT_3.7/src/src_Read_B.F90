!Source src_Read_B
!**-----------------------------------------
!** Module for read Byte values in NETCDF format
...
! ------------------------------------------------------------------------------
!> \brief File which contain subroutine for Read Byte values in NETCDF format 
!! \n  Total 8 functions
...
!<
       ...
       SUBROUTINE MIOL_readf_field_B_4D_NC (cd_filename, &
         ...
         USE netcdf
          ...
          cl_fonction="MIOL_readf_field_B_4D_NC"
          ...
          IF (il_nbdim.NE.4) THEN
             WRITE(0,*) "MIOL_read_field_B_4D_NC: array dimension error. "
             CALL flush(0)
             STOP
          ENDIF
  ...
  !******************************************************************************
       ...
       SUBROUTINE MIOL_readf_field_B_3D_NC (cd_filename, &
          ...
          INTEGER :: il_nbdim, il_type, il_file_id, il_var_id, il_status, il_ji
           ...
           cl_fonction="MIOL_readf_field_B_3D_NC"
          ...
          IF (il_nbdim.NE.3) THEN
             WRITE(0,*) "MIOL_read_field_B_3D_NC: array dimension error. "
             CALL flush(0)
             STOP
          ENDIF
  ...
  !******************************************************************************
       ...
       SUBROUTINE MIOL_readf_field_B_2D_NC (cd_filename, &
          ...
          cl_fonction="MIOL_readf_field_B_2D_NC"
          !----------------------------------------------------------------------
          ! Open file
          ...
          IF (il_nbdim.NE.2) THEN
             WRITE(0,*) "MIOL_read_field_B_2D_NC: array dimension error. "
             CALL flush(0)
             STOP
          ENDIF
  ...
  !******************************************************************************
       ...
       SUBROUTINE MIOL_readf_field_B_1D_NC (cd_filename, &
          ...
          cl_fonction="MIOL_readf_field_B_1D_NC"
          ...
          IF (il_nbdim.NE.1) THEN
             WRITE(0,*) "MIOL_read_field_B_1D_NC: array dimension error. "
             CALL flush(0)
             STOP
          ENDIF
      ...
      !!=====================================================================
       ...
       SUBROUTINE MIOL_readu_field_B_4D_NC (id_file_id, &
         ...
         IMPLICIT NONE
          ...
          cl_fonction="MIOL_readu_field_B_4D_NC" 
          !----------------------------------------------------------------------
          ! Inquire variable
  ...
  !******************************************************************************
       ...
       SUBROUTINE MIOL_readu_field_B_3D_NC (id_file_id, &
         ...
         IMPLICIT NONE
          ...
          cl_fonction="MIOL_readu_field_B_3D_NC" 
          !----------------------------------------------------------------------
          ! Inquire variable
          il_status = fi_ncError(NF90_INQ_VARID(id_file_id, &
                                                cd_varname, &
          ...
          IF (il_nbdim.NE.3) THEN
             ...
             STOP
          ENDIF
          IF ( il_type .NE. NF90_BYTE)  THEN
            WRITE (0,*) 'Declaration Error Type lu non byte '
            STOP
          ENDIF
          !----------------------------------------------------------------------
          ! Read lenght of dimensions
  ...
  !******************************************************************************
       ...
       SUBROUTINE MIOL_readu_field_B_2D_NC (id_file_id, &
         ...
         IMPLICIT NONE
          ...
          cl_fonction="MIOL_readu_field_B_2D_NC"
  ...
  !******************************************************************************
       ...
       SUBROUTINE MIOL_readu_field_B_1D_NC (id_file_id, &
         ...
         IMPLICIT NONE
          ...
          cl_fonction="MIOL_readu_field_B_1D_NC"
