...
!!
!!                                                   
!! \date C.REGNIER  June 2016 Conversion in f90 for interface functions
!! \version Integration MIOL V3.6
!! \date June 2016
!! \version MIOL V3.6
!!==========================================================================
!<
...
MODULE MCAL_gsw_oceanographic_toolbox
    IMPLICIT NONE
    PUBLIC :: gsw_sp_from_c,gsw_c_from_sp,gsw_sp_from_sk,gsw_sa_from_sp,gsw_sstar_from_sp,gsw_ct_from_t,&
            & gsw_deltasa_from_sp,gsw_sr_from_sp,gsw_sp_from_sr,gsw_sp_from_sa,gsw_sstar_from_sa,gsw_sp_from_sstar,gsw_sa_from_sstar,&
            & gsw_ct_from_pt,gsw_pt_from_ct,gsw_pt0_from_t,gsw_pt_from_t,gsw_z_from_p,gsw_entropy_from_t,gsw_adiabatic_lapse_rate_from_ct,&
            & gsw_rho,gsw_alpha,gsw_beta,gsw_alpha_on_beta,gsw_rho_first_derivatives,gsw_specvol,gsw_specvol_anom,gsw_sigma0,gsw_sigma1,gsw_sigma2,&
            & gsw_sigma3,gsw_sigma4,gsw_sound_speed,gsw_kappa,gsw_cabbeling,gsw_thermobaric,gsw_internal_energy,gsw_enthalpy,&
            & gsw_dynamic_enthalpy,gsw_sa_from_rho,gsw_nsquared,gsw_turner_rsubrho,gsw_ipv_vs_fnsquared_ratio,gsw_ct_freezing,gsw_t_freezing,&
            & gsw_latentheat_melting,gsw_latentheat_evap_ct,gsw_latentheat_evap_t,gsw_rho_t_exact,gsw_pot_rho_t_exact,&
            & gsw_alpha_wrt_t_exact,gsw_beta_const_t_exact,gsw_specvol_t_exact,gsw_sound_speed_t_exact,gsw_kappa_t_exact,gsw_enthalpy_t_exact,&
            & gsw_cp_t_exact,gsw_gibbs,gsw_saar,gsw_deltasa_atlas,gsw_fdelta,gsw_sa_from_sp_baltic,gsw_sp_from_sa_baltic,gsw_entropy_part,&
            & gsw_entropy_part_zerop,gsw_gibbs_pt0_pt0,gsw_specvol_sso_0_p,gsw_enthalpy_sso_0_p,gsw_hill_ratio_at_sp2,gsw_grav,gsw_p_from_z

CONTAINS

!==========================================================================
real(kind=8) function gsw_p_from_z (z, lat)
!==========================================================================
!
...
! lat    : latitude                                        [deg]
!
! gsw_p_from_z : height                                    [m]
!--------------------------------------------------------------------------
implicit none
real (kind=8), intent(in) :: z, lat
real (kind=8) :: gamma,db2Pa,deg2rad,sin2,gs, c1, p, df_dp,f,p_old,p_mid
real (kind=8), parameter :: pi = 3.141592653589793d0

gamma = 2.26d-7 
db2Pa = 1d4                             ! factor to convert from dbar to Pa^M
deg2rad = pi/180d0
sin2 = sin(lat*deg2rad)**2
gs = 9.780327*(1.0+(5.2792e-3+(2.32e-5*sin2))*sin2)
c1 =  5.25e-3*sin2 + 5.92e-3
p  = -2*z/((1.0-c1) + sqrt((1.0-c1)*(1.0-c1)+8.84e-6*z))

df_dp = db2Pa*gsw_specvol_sso_0_p(p)
...
gsw_p_from_z  = p_old - f/df_dp

return
end function
!==========================================================================
real(kind=8) function gsw_sp_from_c(c,t,p)       
!==========================================================================
!--------------------------------------------------------------------------
! Practical Salinity (SP), PSS-78
!--------------------------------------------------------------------------
...
real (kind=8), parameter :: a0 = 0.0080d0, a1 = -0.1692d0, a2 = 25.3851d0
real (kind=8), parameter :: a3 = 14.0941d0, a4 = -7.0261d0, a5 = 2.7081d0
real (kind=8), parameter :: b0 = 0.0005d0, b1 = -0.0056d0, b2 = -0.0066d0
real (kind=8), parameter :: b3 = -0.0375d0, b4 = 0.0636d0, b5 = -0.0144d0
real (kind=8), parameter :: c0 = 0.6766097d0, c1 = 2.00564d-2
real (kind=8), parameter :: c2 = 1.104259d-4, c3 = -6.9698d-7, c4 = 1.0031d-9
real (kind=8), parameter :: d1 = 3.426d-2, d2 = 4.464d-4, d3 =  4.215d-1
real (kind=8), parameter :: d4 = -3.107d-3, e1 = 2.070d-5, e2 = -6.370d-10
real (kind=8), parameter :: e3 = 3.989d-15, k  = 0.0162

real (kind=8) :: c, t, p, sp, t68, ft68, r, rt_lc, rp, rt, rtx
!real (kind=8) :: hill_ratio, gsw_hill_ratio_at_sp2, x, sqrty, part1, part2
real (kind=8) :: hill_ratio, x, sqrty, part1, part2
real (kind=8) :: sp_hill_raw
...
!==========================================================================
real(kind=8) function gsw_c_from_sp(sp,t,p)       
!==========================================================================
...
real (kind=8), parameter :: b0 = 0.0005d0, b1 = -0.0056d0, b2 = -0.0066d0
real (kind=8), parameter :: b3 = -0.0375d0, b4 = 0.0636d0, b5 = -0.0144d0
real (kind=8), parameter :: c0 = 0.6766097d0, c1 = 2.00564d-2, c2 = 1.104259d-4
real (kind=8), parameter :: c3 = -6.9698d-7, c4 = 1.0031d-9, d1 = 3.426d-2
real (kind=8), parameter :: d2 = 4.464d-4, d3 = 4.215d-1, d4 = -3.107d-3
real (kind=8), parameter :: e1 = 2.070d-5, e2 = -6.370d-10, e3 = 3.989d-15
real (kind=8), parameter :: p0 = 4.577801212923119d-3, p1 = 1.924049429136640d-1
real (kind=8), parameter :: p2 = 2.183871685127932d-5, p3 = -7.292156330457999d-3
real (kind=8), parameter :: p4 = 1.568129536470258d-4, p5 = -1.478995271680869d-6
real (kind=8), parameter :: p6 = 9.086442524716395d-4, p7 = -1.949560839540487d-5
real (kind=8), parameter :: p8 = -3.223058111118377d-6, p9 = 1.175871639741131d-7
real (kind=8), parameter :: p10 = -7.522895856600089d-5
real (kind=8), parameter :: p11 = -2.254458513439107d-6
real (kind=8), parameter :: p12 = 6.179992190192848d-7
real (kind=8), parameter :: p13 = 1.005054226996868d-8
real (kind=8), parameter :: p14 = -1.923745566122602d-9
real (kind=8), parameter :: p15 = 2.259550611212616d-6
real (kind=8), parameter :: p16 = 1.631749165091437d-7
real (kind=8), parameter :: p17 = -5.931857989915256d-9
real (kind=8), parameter :: p18 = -4.693392029005252d-9
real (kind=8), parameter :: p19 = 2.571854839274148d-10
real (kind=8), parameter :: p20 = 4.198786822861038d-12
real (kind=8), parameter :: q0 = 5.540896868127855d-5, q1 = 2.015419291097848d-1
real (kind=8), parameter :: q2 = -1.445310045430192d-5 
real (kind=8), parameter :: q3 = -1.567047628411722d-2
real (kind=8), parameter :: q4 = 2.464756294660119d-4
real (kind=8), parameter :: q5 = -2.575458304732166d-7
real (kind=8), parameter :: q6 = 5.071449842454419d-3
real (kind=8), parameter :: q7 = 9.081985795339206d-5
real (kind=8), parameter :: q8 = -3.635420818812898d-6
real (kind=8), parameter :: q9 = 2.249490528450555d-8
real (kind=8), parameter :: q10 = -1.143810377431888d-3
real (kind=8), parameter :: q11 = 2.066112484281530d-5
real (kind=8), parameter :: q12 = 7.482907137737503d-7
real (kind=8), parameter :: q13 = 4.019321577844724d-8
real (kind=8), parameter :: q14 = -5.755568141370501d-10
real (kind=8), parameter :: q15 = 1.120748754429459e-4
real (kind=8), parameter :: q16 = -2.420274029674485d-6
real (kind=8), parameter :: q17 = -4.774829347564670d-8
real (kind=8), parameter :: q18 = -4.279037686797859d-9
real (kind=8), parameter :: q19 = -2.045829202713288d-10
real (kind=8), parameter :: q20 = 5.025109163112005d-12
real (kind=8), parameter :: s0 = 3.432285006604888d-3, s1 = 1.672940491817403d-1
real (kind=8), parameter :: s2 = 2.640304401023995d-5, s3 = 1.082267090441036d-1
real (kind=8), parameter :: s4 = -6.296778883666940d-5, s5 = -4.542775152303671d-7
real (kind=8), parameter :: s6 = -1.859711038699727d-1, s7 = 7.659006320303959d-4
real (kind=8), parameter :: s8 = -4.794661268817618d-7, s9 = 8.093368602891911d-9
real (kind=8), parameter :: s10 = 1.001140606840692d-1 
real (kind=8), parameter :: s11 = -1.038712945546608d-3
real (kind=8), parameter :: s12 = -6.227915160991074d-6
real (kind=8), parameter :: s13 = 2.798564479737090d-8
real (kind=8), parameter :: s14 = -1.343623657549961d-10
real (kind=8), parameter :: s15 = 1.024345179842964d-2
real (kind=8), parameter :: s16 = 4.981135430579384d-4
real (kind=8), parameter :: s17 = 4.466087528793912d-6
real (kind=8), parameter :: s18 = 1.960872795577774d-8
real (kind=8), parameter :: s19 = -2.723159418888634d-10
real (kind=8), parameter :: s20 = 1.122200786423241d-12
real (kind=8), parameter :: u0 = 5.180529787390576d-3, u1 = 1.052097167201052d-3
real (kind=8), parameter :: u2 = 3.666193708310848d-5, u3 = 7.112223828976632d0
real (kind=8), parameter :: u4 = -3.631366777096209d-4, u5 = -7.336295318742821d-7
real (kind=8), parameter :: u6 = -1.576886793288888d+2, u7 = -1.840239113483083d-3
real (kind=8), parameter :: u8 = 8.624279120240952d-6, u9 = 1.233529799729501d-8
real (kind=8), parameter :: u10 = 1.826482800939545d+3
real (kind=8), parameter :: u11 = 1.633903983457674d-1
real (kind=8), parameter :: u12 = -9.201096427222349d-5
real (kind=8), parameter :: u13 = -9.187900959754842d-8
real (kind=8), parameter :: u14 = -1.442010369809705d-10
real (kind=8), parameter :: u15 = -8.542357182595853d+3
real (kind=8), parameter :: u16 = -1.408635241899082d0
real (kind=8), parameter :: u17 = 1.660164829963661d-4
real (kind=8), parameter :: u18 = 6.797409608973845d-7
real (kind=8), parameter :: u19 = 3.345074990451475d-10
real (kind=8), parameter :: u20 = 8.285687652694768d-13, k = 0.0162d0

real (kind=8) :: sp, t, p, t68, ft68, x, rtx, dsp_drtx, sqrty
real (kind=8) :: part1, part2, hill_ratio, sp_est
real (kind=8) :: rtx_old, rt, aa, bb, cc, dd, ee, ra,r, rt_lc, rtxm
real (kind=8) :: sp_hill_raw
...
!==========================================================================
real(kind=8) function gsw_sp_from_sk(sk)       
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_sa_from_sp(sp,p,long,lat)       
!==========================================================================
...
real (kind=8) :: sp, long, lat, p,saar

real (kind=8) :: gsw_sa_baltic
...
!==========================================================================
real(kind=8) function gsw_sstar_from_sp(sp,p,long,lat) 
!==========================================================================
...
real (kind=8) :: sp, long, lat, p
real (kind=8) :: saar, sstar_baltic
...
!==========================================================================
real(kind=8) function gsw_ct_from_t(sa,t,p) 
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_deltasa_from_sp(sp,p,long,lat) 
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_sr_from_sp(sp) 
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_sp_from_sr(sr)  
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_sp_from_sa(sa,p,long,lat) 
!==========================================================================
...
real (kind=8) :: sa, long, lat, p, saar
real (kind=8) :: gsw_sp_baltic
...
!==========================================================================
real(kind=8) function gsw_sstar_from_sa(sa,p,long,lat) 
!==========================================================================
...
real (kind=8) :: sa, long, lat, p, gsw_sp_from_sa_baltic
real (kind=8) :: saar
...
!==========================================================================
real(kind=8) function gsw_sa_from_sstar(sstar,p,long,lat)  
!==========================================================================
...
real (kind=8) :: sa, long, lat, p
real (kind=8) :: saar, sstar
...
!==========================================================================
real(kind=8) function gsw_sp_from_sstar(sstar,p,long,lat)  
!==========================================================================
...
real (kind=8) :: long, lat, p
real (kind=8) :: saar, sp_baltic, Sstar
...
!==========================================================================
real(kind=8) function gsw_t_from_ct(sa,ct,p)  
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_ct_from_pt(sa,pt) 
!==========================================================================
...
real (kind=8) :: sa, pt, p, pot_enthalpy, sfac 
real (kind=8) :: x2, x, y, cp0
...
!==========================================================================
real(kind=8) function gsw_pt_from_t(sa,t,p,p_ref) 
!==========================================================================
...
real (kind=8) :: sa, t, p, p_ref, s1
real (kind=8) :: pt, pt_old, de_dt, dentropy, dentropy_dt, sso, cp0
real (kind=8) :: true_entropy_part, ptm
...
!==========================================================================
real(kind=8) function gsw_pt0_from_t(sa,t,p) 
!==========================================================================
...
integer n0, n2, n, no_iter
real (kind=8) :: sa, t, p, s1
real (kind=8) :: pt0, pt0_old, de_dt, dentropy, dentropy_dt, sso, cp0
real (kind=8) :: true_entropy_part, pt0m
...
!==========================================================================
real(kind=8) function gsw_pt_from_ct(sa,ct) 
!==========================================================================
...
real (kind=8) :: sa, ct, s1, p0, cp0 
real (kind=8) :: a0, a1, a2, a3, a4, a5, b0, b1, b2, b3
real (kind=8) :: a5ct, b3ct, ct_factor, pt_num, pt_den, ct_diff
real (kind=8) :: ct0, pt, pt_old, ptm, dct, dct_dpt
...
!==========================================================================
real(kind=8) function gsw_z_from_p(p,lat) 
!==========================================================================
...
real (kind=8) :: p, lat, gamma, deg2rad, x, sin2
real (kind=8) :: b, c, a
...
!==========================================================================
real(kind=8) function gsw_entropy_from_t(sa,t,p) 
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_adiabatic_lapse_rate_from_ct(sa,ct,p) 
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_rho(sa,ct,p) 
!==========================================================================
...
real (kind=8), parameter :: v01 =  9.998420897506056d2, v02 =  2.839940833161907d0
real (kind=8), parameter :: v03 = -3.147759265588511d-2, v04 =  1.181805545074306d-3
real (kind=8), parameter :: v05 = -6.698001071123802d0, v06 = -2.986498947203215d-2
real (kind=8), parameter :: v07 =  2.327859407479162d-4, v08 = -3.988822378968490d-2
real (kind=8), parameter :: v09 =  5.095422573880500d-4, v10 = -1.426984671633621d-5
real (kind=8), parameter :: v11 =  1.645039373682922d-7, v12 = -2.233269627352527d-2
real (kind=8), parameter :: v13 = -3.436090079851880d-4, v14 =  3.726050720345733d-6
real (kind=8), parameter :: v15 = -1.806789763745328d-4, v16 =  6.876837219536232d-7
real (kind=8), parameter :: v17 = -3.087032500374211d-7, v18 = -1.988366587925593d-8
real (kind=8), parameter :: v19 = -1.061519070296458d-11, v20 =  1.550932729220080d-10
real (kind=8), parameter :: v21 =  1.0d0, v22 =  2.775927747785646d-3, v23 = -2.349607444135925d-5
real (kind=8), parameter :: v24 =  1.119513357486743d-6, v25 =  6.743689325042773d-10
real (kind=8), parameter :: v26 = -7.521448093615448d-3, v27 = -2.764306979894411d-5
real (kind=8), parameter :: v28 =  1.262937315098546d-7, v29 =  9.527875081696435d-10
real (kind=8), parameter :: v30 = -1.811147201949891d-11, v31 = -3.303308871386421d-5
real (kind=8), parameter :: v32 =  3.801564588876298d-7, v33 = -7.672876869259043d-9
real (kind=8), parameter :: v34 = -4.634182341116144d-11, v35 =  2.681097235569143d-12
real (kind=8), parameter :: v36 =  5.419326551148740d-6, v37 = -2.742185394906099d-5
real (kind=8), parameter :: v38 = -3.212746477974189d-7, v39 =  3.191413910561627d-9
real (kind=8), parameter :: v40 = -1.931012931541776d-12, v41 = -1.105097577149576d-7
real (kind=8), parameter :: v42 =  6.211426728363857d-10, v43 = -1.119011592875110d-10
real (kind=8), parameter :: v44 = -1.941660213148725d-11, v45 = -1.864826425365600d-14
real (kind=8), parameter :: v46 =  1.119522344879478d-14, v47 = -1.200507748551599d-15
real (kind=8), parameter :: v48 =  6.057902487546866d-17 

real (kind=8) :: sa, ct, p, sqrtsa, v_hat_denominator, v_hat_numerator
...
!==========================================================================
real(kind=8) function gsw_alpha(sa,ct,p)  
!==========================================================================
...
real (kind=8), parameter :: v46 =  1.119522344879478d-14, v47 = -1.200507748551599d-15
real (kind=8), parameter :: v48 =  6.057902487546866d-17 
real (kind=8), parameter :: a01 =  2.839940833161907d0, a02 = -6.295518531177023d-2
real (kind=8), parameter :: a03 =  3.545416635222918d-3, a04 = -2.986498947203215d-2
real (kind=8), parameter :: a05 =  4.655718814958324d-4, a06 =  5.095422573880500d-4
real (kind=8), parameter :: a07 = -2.853969343267241d-5, a08 =  4.935118121048767d-7
real (kind=8), parameter :: a09 = -3.436090079851880d-4, a10 =  7.452101440691467d-6
real (kind=8), parameter :: a11 =  6.876837219536232d-7, a12 = -1.988366587925593d-8
real (kind=8), parameter :: a13 = -2.123038140592916d-11, a14 =  2.775927747785646d-3
real (kind=8), parameter :: a15 = -4.699214888271850d-5, a16 =  3.358540072460230d-6
real (kind=8), parameter :: a17 =  2.697475730017109d-9, a18 = -2.764306979894411d-5
real (kind=8), parameter :: a19 =  2.525874630197091d-7, a20 =  2.858362524508931d-9
real (kind=8), parameter :: a21 = -7.244588807799565d-11, a22 =  3.801564588876298d-7
real (kind=8), parameter :: a23 = -1.534575373851809d-8, a24 = -1.390254702334843d-10
real (kind=8), parameter :: a25 =  1.072438894227657d-11, a26 = -3.212746477974189d-7
real (kind=8), parameter :: a27 =  6.382827821123254d-9, a28 = -5.793038794625329d-12
real (kind=8), parameter :: a29 =  6.211426728363857d-10, a30 = -1.941660213148725d-11
real (kind=8), parameter :: a31 = -3.729652850731201d-14, a32 =  1.119522344879478d-14
real (kind=8), parameter :: a33 =  6.057902487546866d-17

real (kind=8) :: sa, ct, p, sqrtsa, v_hat_denominator, v_hat_numerator
real (kind=8) :: dvhatden_dct, dvhatnum_dct
...
!==========================================================================
real(kind=8) function gsw_beta(sa,ct,p) 
!==========================================================================
...
real (kind=8), parameter :: v46 =  1.119522344879478d-14, v47 = -1.200507748551599d-15
real (kind=8), parameter :: v48 =  6.057902487546866d-17 
real (kind=8), parameter :: b01 = -6.698001071123802d0, b02 = -2.986498947203215d-2
real (kind=8), parameter :: b03 =  2.327859407479162d-4, b04 = -5.983233568452735d-2
real (kind=8), parameter :: b05 =  7.643133860820750d-4, b06 = -2.140477007450431d-5
real (kind=8), parameter :: b07 =  2.467559060524383d-7, b08 = -1.806789763745328d-4
real (kind=8), parameter :: b09 =  6.876837219536232d-7, b10 =  1.550932729220080d-10
real (kind=8), parameter :: b11 = -7.521448093615448d-3, b12 = -2.764306979894411d-5
real (kind=8), parameter :: b13 =  1.262937315098546d-7, b14 =  9.527875081696435d-10
real (kind=8), parameter :: b15 = -1.811147201949891d-11, b16 = -4.954963307079632d-5
real (kind=8), parameter :: b17 =  5.702346883314446d-7, b18 = -1.150931530388857d-8
real (kind=8), parameter :: b19 = -6.951273511674217d-11, b20 =  4.021645853353715d-12
real (kind=8), parameter :: b21 =  1.083865310229748d-5, b22 = -1.105097577149576d-7
real (kind=8), parameter :: b23 =  6.211426728363857d-10, b24 =  1.119522344879478d-14

real (kind=8) :: sa, ct, p, sqrtsa, v_hat_denominator, v_hat_numerator
real (kind=8) :: dvhatden_dsa, dvhatnum_dsa 
...
!==========================================================================
real(kind=8) function gsw_alpha_on_beta(sa,ct,p)  
!==========================================================================
...
real (kind=8), parameter :: b21 =  1.083865310229748d-5, b22 = -1.105097577149576d-7
real (kind=8), parameter :: b23 =  6.211426728363857d-10, b24 =  1.119522344879478d-14
real (kind=8), parameter :: c01 = -2.233269627352527d-2,  c02 = -3.436090079851880d-4
real (kind=8), parameter :: c03 =  3.726050720345733d-6,  c04 = -1.806789763745328d-4
real (kind=8), parameter :: c05 =  6.876837219536232d-7,  c06 = -6.174065000748422d-7
real (kind=8), parameter :: c07 = -3.976733175851186d-8,  c08 = -2.123038140592916d-11
real (kind=8), parameter :: c09 =  3.101865458440160d-10, c10 = -2.742185394906099d-5
real (kind=8), parameter :: c11 = -3.212746477974189d-7,  c12 =  3.191413910561627d-9
real (kind=8), parameter :: c13 = -1.931012931541776d-12, c14 = -1.105097577149576d-7
real (kind=8), parameter :: c15 =  6.211426728363857d-10, c16 = -2.238023185750219d-10
real (kind=8), parameter :: c17 = -3.883320426297450d-11, c18 = -3.729652850731201d-14
real (kind=8), parameter :: c19 =  2.239044689758956d-14, c20 = -3.601523245654798d-15
real (kind=8), parameter :: c21 =  1.817370746264060d-16, pa2db = 1d-4

real (kind=8) :: sa, ct, p, sqrtsa, v_hat_denominator, v_hat_numerator
real (kind=8) :: dvhatden_dct, dvhatnum_dct, dvhatden_dsa, dvhatnum_dsa
real (kind=8) :: dvhatden_dp, dvhatnum_dp, rho, rec_num, drho_dsa, drho_dct, drho_dp
...
!==========================================================================
real(kind=8) function gsw_specvol(sa,ct,p) 
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_specvol_anom(sa,ct,p)  
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_sigma0(sa,ct) 
!==========================================================================
...
real (kind=8), parameter :: v07 =  2.327859407479162d-4, v08 = -3.988822378968490d-2
real (kind=8), parameter :: v09 =  5.095422573880500d-4, v10 = -1.426984671633621d-5
real (kind=8), parameter :: v11 =  1.645039373682922d-7
real (kind=8), parameter :: v21 =  1.0d0, v22 =  2.775927747785646d-3, v23 = -2.349607444135925d-5
real (kind=8), parameter :: v24 =  1.119513357486743d-6, v25 =  6.743689325042773d-10
real (kind=8), parameter :: v26 = -7.521448093615448d-3, v27 = -2.764306979894411d-5
real (kind=8), parameter :: v28 =  1.262937315098546d-7, v29 =  9.527875081696435d-10
...
real (kind=8), parameter :: v32 =  3.801564588876298d-7, v33 = -7.672876869259043d-9
real (kind=8), parameter :: v34 = -4.634182341116144d-11, v35 =  2.681097235569143d-12
real (kind=8), parameter :: v36 =  5.419326551148740d-6

real (kind=8) :: sa, ct, v_hat_denominator, v_hat_numerator, sqrtsa
...
!==========================================================================
real(kind=8) function gsw_sigma1(sa,ct) 
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_sigma2(sa,ct) 
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_sigma3(sa,ct) 
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_sigma4(sa,ct) 
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_sound_speed(sa,ct,p) 
!==========================================================================
...
real (kind=8), parameter :: c17 = -3.883320426297450d-11, c18 = -3.729652850731201d-14
real (kind=8), parameter :: c19 =  2.239044689758956d-14, c20 = -3.601523245654798d-15
real (kind=8), parameter :: c21 =  1.817370746264060d-16

real (kind=8) :: sa, ct, p, v_hat_denominator, v_hat_numerator
real (kind=8) :: sqrtsa, dvhatden_dp, dvhatnum_dp, dp_drho
...
!==========================================================================
real(kind=8) function gsw_kappa(sa,ct,p)  
!==========================================================================
...
real (kind=8) :: sa, ct, p, v_hat_denominator, v_hat_numerator
real (kind=8) :: sqrtsa, dvden_dp, dvnum_dp
...
!==========================================================================
real(kind=8) function gsw_cabbeling(sa,ct,p)  
!==========================================================================
...
real (kind=8) :: sa, ct, p, sqrtsa, v_hat_denominator, v_hat_numerator
real (kind=8) :: dvhatden_dct, dvhatnum_dct, dvhatden_dctdct, dvhatden_dctdsa
real (kind=8) :: dvhatden_dsa, dvhatnum_dsa, dvhatnum_dsadsa, dvhatden_dsadsa
real (kind=8) :: dvhatnum_dctdct, dvhatnum_dsadct, dvhatnum_dctdsa
real (kind=8) :: p1a, p1b, p1c, p1d, part1, factor2a, factor2b
real (kind=8) :: p2a, p2b, p2c, p2d, p2e, part2 
real (kind=8) :: factor3a, factor3b, p3a, p3b, p3c, p3d, part3 
...
!==========================================================================
real(kind=8) function gsw_thermobaric(sa,ct,p)  
!==========================================================================
...
real (kind=8), parameter :: c17 = -3.883320426297450d-11, c18 = -3.729652850731201d-14
real (kind=8), parameter :: c19 =  2.239044689758956d-14, c20 = -3.601523245654798d-15
real (kind=8), parameter :: c21 =  1.817370746264060d-16, rec_db2pa = 1d-4

real (kind=8) :: sa, ct, p, sqrtsa, v_hat_denominator, v_hat_numerator
real (kind=8) :: dvhatden_dct, dvhatnum_dct, dvhatden_dp, dvhatnum_dp
real (kind=8) :: dvhatden_dsa, dvhatnum_dsa, dvhatden_dpdct, dvhatnum_dpdct
real (kind=8) :: dvhatden_dpdsa, dvhatnum_dpdsa 
real (kind=8) :: p1a, p1b, p1c, p1d, p1e, part1, factor2
real (kind=8) :: p2a, p2b, p2c, p2d, p2e, part2  
...
!==========================================================================
real(kind=8) function gsw_internal_energy(sa,ct,p)  
!==========================================================================
...
real (kind=8), parameter :: p0 = 101325d0, db2pa = 1d4
...
!==========================================================================
real(kind=8) function gsw_enthalpy(sa,ct,p)  
!==========================================================================
...
real (kind=8), parameter :: v01 =  9.998420897506056d+2, v02 =  2.839940833161907d0
real (kind=8), parameter :: v03 = -3.147759265588511d-2, v04 =  1.181805545074306d-3
real (kind=8), parameter :: v05 = -6.698001071123802d0, v06 = -2.986498947203215d-2
real (kind=8), parameter :: v07 =  2.327859407479162d-4, v08 = -3.988822378968490d-2
real (kind=8), parameter :: v09 =  5.095422573880500d-4, v10 = -1.426984671633621d-5
...
real (kind=8) :: sa, ct, p, db2pa, cp0, sqrtsa, a0, a1, a2, a3, b0, b1, b2, b1sq
real (kind=8) :: sqrt_disc, ca, cb, cn, cm, part
...
!==========================================================================
real(kind=8) function gsw_dynamic_enthalpy(sa,ct,p) 
!==========================================================================
...
real (kind=8) :: sa, ct, p, db2pa, sqrtsa, a0, a1, a2, a3, b0, b1, b2, b1sq
real (kind=8) :: sqrt_disc, ca, cb, cn, cm, part
...
!==========================================================================
real(kind=8) function gsw_sa_from_rho(rho,ct,p)
!==========================================================================
...
real (kind=8) :: rho, ct, p, sa, v_lab, v_0, v_50, v_sa
real (kind=8) :: sa_old, delta_v, sa_mean, alpha,beta
...
real (kind=8), parameter :: db2pa = 1d4
real (kind=8) :: grav_local, dsa, sa_mid, dct, ct_mid, dp, rho_mid
real (kind=8) :: alpha_mid, beta_mid
real (kind=8), dimension(nz) :: sa, ct, p, lat
real (kind=8), dimension(nz-1) :: p_mid, n2
...
real (kind=8), parameter :: pi = 3.141592653589793d0
real (kind=8) :: dsa, sa_mid, dct, ct_mid, dp
real (kind=8) :: alpha_mid, beta_mid
real (kind=8), dimension(nz) :: sa, ct, p
real (kind=8), dimension(nz-1) :: tu, rsubrho, p_mid
...
real (kind=8) :: dsa, sa_mid, dct, ct_mid, dp, p_ref
real (kind=8) :: alpha_mid, beta_mid
real (kind=8) :: alpha_pref, beta_pref, numerator, denominator
real (kind=8), dimension(nz) :: sa, ct, p
real (kind=8), dimension(nz-1) :: ipv_vs_fnsquared_ratio, p_mid
...
!==========================================================================
real(kind=8) function gsw_ct_freezing(sa,p,saturation_fraction) 
!==========================================================================
...
real (kind=8), parameter :: c0 = 0.017947064327968736d0, c1 = -6.076099099929818d0
real (kind=8), parameter :: c2 = 4.883198653547851d0, c3 = -11.88081601230542d0
real (kind=8), parameter :: c4 = 13.34658511480257d0, c5 = -8.722761043208607d0
real (kind=8), parameter :: c6 = 2.082038908808201d0, c7 = -7.389420998107497d0
real (kind=8), parameter :: c8 = -2.110913185058476d0, c9 = 0.2295491578006229d0
real (kind=8), parameter :: c10 = -0.9891538123307282d0, c11 = -0.08987150128406496d0
real (kind=8), parameter :: c12 = 0.3831132432071728d0, c13 = 1.054318231187074d0
real (kind=8), parameter :: c14 = 1.065556599652796d0, c15 = -0.7997496801694032d0
real (kind=8), parameter :: c16 = 0.3850133554097069d0, c17 = -2.078616693017569d0
real (kind=8), parameter :: c18 = 0.8756340772729538d0, c19 = -2.079022768390933d0
real (kind=8), parameter :: c20 = 1.596435439942262d0, c21 = 0.1338002171109174d0
real (kind=8), parameter :: c22 = 1.242891021876471d0

real (kind=8) :: sa, p, saturation_fraction, ct_freezing
real (kind=8) :: sa_r, x, p_r, a, b
...
!==========================================================================
real(kind=8) function gsw_t_freezing(sa,p,saturation_fraction) 
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_latentheat_melting(sa,p)  
!==========================================================================
...
real (kind=8), parameter :: c0 =  3.334265169240710d5, c1 = -2.789444646733159d0
real (kind=8), parameter :: c2 = -1.822150156453350d4, c3 = -4.984585692734338d3
real (kind=8), parameter :: c4 = -7.371966528571920d1, c5 = -7.605802553358546d3
real (kind=8), parameter :: c6 =  1.195857305019339d3, c7 =  1.233720336206392d3
real (kind=8), parameter :: c8 =  2.294798676591890d2, c9 =  9.655751370889338d2
real (kind=8), parameter :: c10 = -5.792068522727968d2, c11 = -1.649446955902331d3
real (kind=8), parameter :: c12 = -1.029021448430547d3, c13 = -3.171558017172501d2
real (kind=8), parameter :: c14 = -1.751401389905041d2, c15 =  6.836527214265952d2
real (kind=8), parameter :: c16 =  1.078283734113611d3, c17 =  5.613896351265648d2
real (kind=8), parameter :: c18 =  6.968934948667265d2, c19 =  1.793032021946783d2
real (kind=8), parameter :: c20 =  8.692558481134256d1, c21 = -2.371103254714944d2
real (kind=8), parameter :: c22 = -5.775033277201674d2, c23 = -3.019749254648732d2
real (kind=8), parameter :: c24 = -6.420420579160927d2, c25 = -2.657570848596042d2
real (kind=8), parameter :: c26 = -1.646738151143109d1, c27 =  4.618228988300871d0

real (kind=8) :: sa, p, s_u, x, y
...
!==========================================================================
real(kind=8) function gsw_latentheat_evap_ct(sa,ct) 
!==========================================================================
...
real (kind=8), parameter :: c0 =   2.499065844825125d6, c1 =  -1.544590633515099d-1
real (kind=8), parameter :: c2 =  -9.096800915831875d4, c3 =   1.665513670736000d2
real (kind=8), parameter :: c4 =   4.589984751248335d1, c5 =   1.894281502222415d1
real (kind=8), parameter :: c6 =   1.192559661490269d3, c7 =  -6.631757848479068d3
real (kind=8), parameter :: c8 =  -1.104989199195898d2, c9 =  -1.207006482532330d3
real (kind=8), parameter :: c10 = -3.148710097513822d3, c11 =  7.437431482069087d2
real (kind=8), parameter :: c12 =  2.519335841663499d3, c13 =  1.186568375570869d1
real (kind=8), parameter :: c14 =  5.731307337366114d2, c15 =  1.213387273240204d3
real (kind=8), parameter :: c16 =  1.062383995581363d3, c17 = -6.399956483223386d2
real (kind=8), parameter :: c18 = -1.541083032068263d3, c19 =  8.460780175632090d1
real (kind=8), parameter :: c20 = -3.233571307223379d2, c21 = -2.031538422351553d2
real (kind=8), parameter :: c22 =  4.351585544019463d1, c23 = -8.062279018001309d2
real (kind=8), parameter :: c24 =  7.510134932437941d2, c25 =  1.797443329095446d2
real (kind=8), parameter :: c26 = -2.389853928747630d1, c27 =  1.021046205356775d2

real (kind=8) :: sa, ct, s_u, x, y
...
!==========================================================================
real(kind=8) function gsw_latentheat_evap_t(sa,t)  
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_grav(lat,p)  
!==========================================================================
...
real (kind=8) :: lat, p, gamma, deg2rad, x, sin2, gs, z
...
!==========================================================================
real(kind=8) function gsw_rho_t_exact(sa,t,p) 
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_pot_rho_t_exact(sa,t,p,p_ref)  
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_alpha_wrt_t_exact(sa,t,p) 
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_beta_const_t_exact(sa,t,p)  
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_specvol_t_exact(sa,t,p)  
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_sound_speed_t_exact(sa,t,p)  
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_kappa_t_exact(sa,t,p)  
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_enthalpy_t_exact(sa,t,p) 
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_cp_t_exact(sa,t,p)    
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_gibbs(ns,nt,np,sa,t,p)
!==========================================================================
...
integer :: ns, nt, np
real (kind=8) :: sa, t, p
real (kind=8) :: sfac, x2, x, y, z, g03, g08
...
!==========================================================================
real(kind=8) function gsw_saar(p,long,lat)
!==========================================================================
...
real (kind=8), dimension(4) :: saar, saar_old
real (kind=8), dimension(nz) :: p_ref
real (kind=8), dimension(ny) :: lats_ref
real (kind=8), dimension(nx) :: longs_ref
real (kind=8), dimension(ny,nx) :: ndepth_ref 
real (kind=8), dimension(nz,ny,nx) :: saar_ref
!real (kind=8), dimension(nz,ny,nx) :: delta_sa_ref
real (kind=8) :: p, lat, long, dlong, dlat
real (kind=8) :: p0_original, lon0_in, sa_upper, sa_lower 
real (kind=8) :: r1, s1, t1, saar_mean, ndepth_max, p_tmp, long_tmp
...
if(icalled.eq.0d0) then
  icalled = 1
   open(10,file=TRIM('/home/cregnier/DEV/Package_alleges/INSTALL/intel')//TRIM('/param/statics/gsw_data_v3_0.dat'),status='old',err=1)
   flag_saar = 1
...
!==========================================================================
real(kind=8) function gsw_deltasa_atlas(p,long,lat)
!==========================================================================
...
real (kind=8), dimension(4) :: dsar, dsar_old
real (kind=8), dimension(nz) :: p_ref
real (kind=8), dimension(ny) :: lats_ref
real (kind=8), dimension(nx) :: longs_ref
real (kind=8), dimension(ny,nx) :: ndepth_ref 
real (kind=8), dimension(nz,ny,nx) :: saar_ref, delta_sa_ref
real (kind=8) :: p, lat, long, dlong, dlat
real (kind=8) :: p0_original, lon0_in, sa_upper, sa_lower 
real (kind=8) :: r1, s1, t1, dsar_mean, ndepth_max, p_tmp, long_tmp
...
real (kind=8), dimension(4) :: input_data, output_data
real (kind=8), dimension(6) :: longs_pan, lats_pan
real (kind=8) :: long, lat, r, lats_line, long_grid, lat_grid
real (kind=8) :: dlong_grid, dlat_grid, data_mean
...
real (kind=8), dimension(4) :: data_in, data_out 
real (kind=8) :: data_mean, long, lat
...
!==========================================================================
real(kind=8) function xinterp1(x,y,n,x0)
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_fdelta(p,long,lat)
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_sa_from_sp_baltic(sp,long,lat)
!==========================================================================
...
real (kind=8), dimension(2) :: xb_right, yb_right
real (kind=8), dimension(3) :: xb_left, yb_left
real (kind=8) :: sp, long, lat, xx_left, xx_right
...
!==========================================================================
real(kind=8) function gsw_sp_from_sa_baltic(sa,long,lat)
!==========================================================================
...
real (kind=8), dimension(2) :: xb_right, yb_right
real (kind=8), dimension(3) :: xb_left, yb_left
real (kind=8) :: sa, long, lat, xx_left, xx_right
...
!==========================================================================
real(kind=8) function gsw_entropy_part(sa,t,p)
!==========================================================================

! entropy minus the terms that are a real(kind=8) function of only SA
!
! sa     : Absolute Salinity                               [g/kg]
! t      : in-situ temperature                             [deg C]
! p      : sea pressure                                    [dbar]
...
real (kind=8) :: sa, t, p, sfac, x2, x, y, z, g03, g08
...
!==========================================================================
real(kind=8) function gsw_entropy_part_zerop(sa,pt0)
!==========================================================================
...
real (kind=8) :: sa, pt0, sfac, x2, x, y, g03, g08
...
!==========================================================================
real(kind=8) function gsw_gibbs_pt0_pt0(sa,pt0)
!==========================================================================
...
!==========================================================================
real(kind=8) function gsw_specvol_sso_0_p(p) 
!==========================================================================
...
real (kind=8), parameter :: v01 =  9.998420897506056d2, v05 = -6.698001071123802d0
real (kind=8), parameter :: v08 = -3.988822378968490d-2, v12 = -2.233269627352527d-2
real (kind=8), parameter :: v15 = -1.806789763745328d-4, v17 = -3.087032500374211d-7
real (kind=8), parameter :: v20 =  1.550932729220080d-10, v21 =  1.0d0;
real (kind=8), parameter :: v26 = -7.521448093615448d-3, v31 = -3.303308871386421d-5
real (kind=8), parameter :: v36 =  5.419326551148740d-6, v37 = -2.742185394906099d-5
real (kind=8), parameter :: v41 = -1.105097577149576d-7, v43 = -1.119011592875110d-10
real (kind=8), parameter :: v47 = -1.200507748551599d-15

real (kind=8) :: sso, sqrtsso, p
...
!==========================================================================
real(kind=8) function gsw_enthalpy_SSO_0_p(p) 
!==========================================================================

!  This real(kind=8) function calculates enthalpy at the Standard Ocean Salinity, SSO, 
...
real (kind=8), parameter :: v36 =  5.419326551148740d-6, v37 = -2.742185394906099d-5
real (kind=8), parameter :: v41 = -1.105097577149576d-7, v43 = -1.119011592875110d-10
real (kind=8), parameter :: v47 = -1.200507748551599d-15, db2pa = 1d4  
real (kind=8), parameter :: sso = 35.16504d0, sqrtsso = 5.930011804372737d0

real (kind=8) :: p, a0, a1, a2, a3
real (kind=8) :: b0, b1, b2, b1sq, sqrt_disc, n, m, a, b, part
...
!==========================================================================
real(kind=8) function  gsw_hill_ratio_at_sp2(t)
!==========================================================================
...
real (kind=8), parameter :: b0 =  0.0005d0, b1 = -0.0056d0, b2 = -0.0066d0
real (kind=8), parameter :: b3 = -0.0375d0, b4 =  0.0636d0, b5 = -0.0144d0
real (kind=8), parameter :: g0 = 2.641463563366498d-1, g1 = 2.007883247811176d-4
real (kind=8), parameter :: g2 = -4.107694432853053d-6, g3 = 8.401670882091225d-8
real (kind=8), parameter :: g4 = -1.711392021989210d-9, g5 = 3.374193893377380d-11
real (kind=8), parameter :: g6 = -5.923731174730784d-13, g7 = 8.057771569962299d-15
real (kind=8), parameter :: g8 = -7.054313817447962d-17, g9 = 2.859992717347235d-19
real (kind=8), parameter :: rk  =  0.0162d0, sp2 = 2d0

real (kind=8) :: t, t68, ft68, rtx0, dsp_drtx, sp_est, rtx, rtxm, x, part1, part2
real (kind=8) :: sqrty, sp_hill_raw_at_sp2
...
!==========================================================================
END MODULE MCAL_gsw_oceanographic_toolbox
