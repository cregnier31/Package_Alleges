...
!**-----------------------------------------
! ---  MIOL_readf_field_I8_4D_NC(cd_filename,cd_varname,idpa_value,ida_dimsize)
! ---  MIOL_readf_field_I8_3D_NC(cd_filename,cd_varname,idpa_value,ida_dimsize)
! ---  MIOL_readf_field_I8_2D_NC(cd_filename,cd_varname,idpa_value,ida_dimsize)
! ---  MIOL_readf_field_I8_1D_NC(cd_filename,cd_varname,idpa_value,ida_dimsize)
! ---  MIOL_readu_field_I8_4D_NC (id_file_id,cd_varname,idpa_value,ida_dimsize)
! ---  MIOL_readu_field_I8_3D_NC (id_file_id,cd_varname,idpa_value,ida_dimsize)
! ---  MIOL_readu_field_I8_2D_NC (id_file_id,cd_varname,idpa_value,ida_dimsize)
! ---  MIOL_readu_field_I8_1D_NC (id_file_id,cd_varname,idpa_value,ida_dimsize)
!**-----------------------------------------
...
!< 
  ...
  !******************************************************************************
       ...
       SUBROUTINE MIOL_readf_field_I8_4D_NC (cd_filename, &
                                         cd_varname, &
                                         idpa_value, &
                                         ida_dimsize)
         ...
         USE MFT_error
          ...
          INTEGER(KIND=8), DIMENSION(:,:,:,:), POINTER :: idpa_value
          ...
          !----------------------------------------------------------------------
          ! Open file
          cl_fonction="MIOL_readf_field_I8_3D_NC"
          ...
          IF (il_nbdim.NE.4) THEN
             WRITE(0,*) "MIOL_read_field_I8_4D_NC: array dimension error. "
             CALL flush(0)
             STOP
          ENDIF
        ...
        END SUBROUTINE MIOL_readf_field_I8_4D_NC
  ...
  !******************************************************************************
       ...
       SUBROUTINE MIOL_readf_field_I8_3D_NC (cd_filename, &
                                         cd_varname, &
                                         idpa_value, &
                                         ida_dimsize)
        ...
        END SUBROUTINE MIOL_readf_field_I8_3D_NC
  ...
  !******************************************************************************
       ...
       SUBROUTINE MIOL_readf_field_I8_2D_NC (cd_filename, &
                                         cd_varname, &
                                         idpa_value, &
                                         ida_dimsize)
         ...
         IMPLICIT NONE
          ...
          cl_fonction="MIOL_readf_field_I8_2D_NC"
          !----------------------------------------------------------------------
          ! Open file
          il_status = fi_ncError(NF90_OPEN(TRIM(cd_filename), &
                                           NF90_NOWRITE, &
          ...
          IF (il_nbdim.NE.2) THEN
             WRITE(0,*) "MIOL_read_field_I8_2D_NC: array dimension error. "
             CALL flush(0)
             STOP
          ENDIF
        ...
        END SUBROUTINE MIOL_readf_field_I8_2D_NC
  ...
  !******************************************************************************
       ...
       SUBROUTINE MIOL_readf_field_I8_1D_NC (cd_filename, &
                                         cd_varname, &
                                         idpa_value, &
                                         ida_dimsize)
         ...
         IMPLICIT NONE
          ...
          cl_fonction="MIOL_readf_field_I8_1D_NC"
          !----------------------------------------------------------------------
          ! Open file
          ...
          IF (il_nbdim.NE.1) THEN
             WRITE(0,*) "MIOL_read_field_I8_1D_NC: array dimension error. "
             CALL flush(0)
             STOP
          ENDIF
        ...
        END SUBROUTINE MIOL_readf_field_I8_1D_NC
  ...
  !******************************************************************************
       ...
       SUBROUTINE MIOL_readu_field_I8_4D_NC (id_file_id, &
                                         cd_varname, &
                                         idpa_value, &
                                         ida_dimsize)
          ...
          cl_fonction="MIOL_readu_field_I8_4D_NC"
          !----------------------------------------------------------------------
          ! Inquire variable
        ...
        END SUBROUTINE MIOL_readu_field_I8_4D_NC
  ...
  !******************************************************************************
       ...
       SUBROUTINE MIOL_readu_field_I8_3D_NC (id_file_id, &
                                         cd_varname, &
                                         idpa_value, &
                                         ida_dimsize)
          ...
          cl_fonction="MIOL_readu_field_I8_3D_NC"
          !----------------------------------------------------------------------
          ! Inquire variable
          il_status = fi_ncError(NF90_INQ_VARID(id_file_id, &
                                                cd_varname, &
        ...
        END SUBROUTINE MIOL_readu_field_I8_3D_NC
  ...
  !******************************************************************************
       ...
       SUBROUTINE MIOL_readu_field_I8_2D_NC (id_file_id, &
                                         cd_varname, &
                                         idpa_value, &
                                         ida_dimsize)
         ...
         IMPLICIT NONE
          ...
          cl_fonction="MIOL_readu_field_I8_2D_NC"
          !----------------------------------------------------------------------
          ! Inquire variable
          il_status = fi_ncError(NF90_INQ_VARID(id_file_id, &
                                                cd_varname, &
        ...
        END SUBROUTINE MIOL_readu_field_I8_2D_NC
  ...
  !******************************************************************************
       ...
       SUBROUTINE MIOL_readu_field_I8_1D_NC (id_file_id, &
                                         cd_varname, &
                                         idpa_value, &
                                         ida_dimsize)
         ...
         IMPLICIT NONE
          ...
          cl_fonction="MIOL_readu_field_I8_1D_NC"
          !----------------------------------------------------------------------
          ! Inquire variable
          il_status = fi_ncError(NF90_INQ_VARID(id_file_id, &
                                                cd_varname, &
        ...
        END SUBROUTINE MIOL_readu_field_I8_1D_NC
